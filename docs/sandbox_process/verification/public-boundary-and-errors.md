...
[test_public_package.py](../../../tests/sandbox_process/unit/test_public_package.py):
...
[test_public_config_pipeline.py](../../../tests/sandbox_process/e2e/public_boundary/test_public_config_pipeline.py):
...
`uv run pytest tests/sandbox_process/e2e/examples`
