...
description: High-level public boundary and error model for sandbox process. Use when you need to understand what may leave the package boundary.
---
...
This document describes what callers should receive from sandbox process
...
- `SampleLibError` is the package-specific public error base.
