...
description: Justification for the runtime dependencies declared by sandbox-process. Use when you need to understand what each shipped dependency supports.
---
