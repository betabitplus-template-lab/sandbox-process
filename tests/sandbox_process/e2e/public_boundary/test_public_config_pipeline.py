# %%
"""Sandbox Process public config boundary scenario.
...
Covers:
    ...
    Interface: top-level `sandbox_process`
...
Checks:
    ...
    Examples:
        Run manually:
            uv run python -m \
                tests.sandbox_process.e2e.public_boundary.test_public_config_pipeline
